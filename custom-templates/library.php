		...
		<div class= "card card-js">
                ...
                <div class="card-content">
                    ...
                    <div id="LibraryPageId103" class="tabcontentLibraryPage tabcontent">
					 	<?php echo do_shortcode('[wpdm_all_packages categories="md規程" jstable=1 items_per_page=10]'); ?>
                    </div> 

                    <div id="LibraryPageId104" class="tabcontentLibraryPage tabcontent">
					 	<?php echo do_shortcode('[wpdm_all_packages categories="pubridge規程" jstable=1 items_per_page=10]'); ?>
                    </div> 

                    <div id="LibraryPageId105" class="tabcontentLibraryPage tabcontent">
					 	<?php echo do_shortcode('[wpdm_all_packages categories="情報セキュリティ規程" jstable=1 items_per_page=10]'); ?>
                    </div>
