    ...
    <div class="container main-page" id="libary-page-id">
        <div class="card card-js">
            ...
            <div class="card-content">
                <div class="tab">
                    <button class="tablinksLibraryPage" onclick="openTabLibraryPage(event, 'LibraryPageId101')"
                        id="defaultOpen-library-page">各種DLリンク</button>
                    <button class="tablinksLibraryPage"
                        onclick="openTabLibraryPage(event, 'LibraryPageId102')">社内規程（MDHD）</button>
                    <button class="tablinksLibraryPage"
                        onclick="openTabLibraryPage(event, 'LibraryPageId103')">社内規程（MD）</button>
                    <button class="tablinksLibraryPage"
                        onclick="openTabLibraryPage(event, 'LibraryPageId104')">社内規程（出版デジタル機構）</button>
                    <button class="tablinksLibraryPage"
                        onclick="openTabLibraryPage(event, 'LibraryPageId105')">情報セキュリティ規程</button>
                </div>
                    ...
                    <div>
                        ...
                        <ul>
                            <li><i class="fas fa-chevron-right"></i><a
                                    href="https://drive.google.com/drive/u/0/folders/1-HgMc2Rx3DORqkXJqeG3nt6bd8sSQgdG">
                                    MD0312リスク管理規程 </a>
                                <ul>
                                    <li><i class="fas fa-chevron-right"></i><a
                            ...
                            <li><i class="fas fa-chevron-right"></i><a
                                    href="https://drive.google.com/drive/u/0/folders/1XFO9Sr0BdLBkDcZ5R272soCm37FWzvVt">
                                    MD0314特定個人情報等取扱規程 </a>
                                <ul>
                                    <li><i class="fas fa-chevron-right"></i><a
                            ...
                            <li><i class="fas fa-chevron-right"></i><a
                                    href="https://drive.google.com/file/d/1ZYl_n0K4hOfEkeBGzx6JPhznNwU6mCTh/view">MD0303秘密保持規程（グループ共通）
                                    _2018.09.01.pdf
                                </a>
                            </li>
                            <li><i class="fas fa-chevron-right"></i><a
